...
const HomeScreen = ({ navigation }) => {
  const stories = [
    { id: 'story-0', type: 'story', source: require('../assets/my-profile.jpg'), name: 'Seu story' }, 
    { id: 'story-1', type: 'story', source: require('../assets/story2.jpg'), name: 'dog' },
    { id: 'story-2', type: 'story', source: require('../assets/story3.jpg'), name: 'mateus' },
  ...
  const posts = [
    {
      id: 'post-1',
      type: 'post',
      profileImage: require('../assets/my-profile.jpg'),
      profileName: 'vitoorhugo_',
    ...
    },
    {
      id: 'post-2',
      type: 'post',
      profileImage: require('../assets/story3.jpg'),
      profileName: 'mateus',
